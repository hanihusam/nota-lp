    ...
    <section className="pt-24 lg:pt-32 flex flex-col gap-16 items-center">
      <div className="max-w-6xl mx-auto px-5 lg:px-0 w-full flex flex-col gap-8">
        <div className="flex flex-col gap-6 w-full">
          <div className="flex flex-col gap-4 max-w-full lg:max-w-[585px]">
        ...
        <div className="flex flex-col lg:flex-row items-stretch lg:items-center gap-4">
          <Button variant="primary" size="lg" className="justify-center lg:justify-start">
            Get Started
          </Button>
          <Button variant="secondary" size="lg" iconPosition="right" className="justify-center lg:justify-start">
            See How It Works
          </Button>
        </div>
      </div>
